...
import (
	...
	"github.com/mfisher1411/microservices_course/week_2/config/internal/config"
	"github.com/mfisher1411/microservices_course/week_2/config/internal/config/env"
	desc "github.com/mfisher1411/microservices_course/week_2/config/pkg/note_v1"
)
...
func (s *server) Get(ctx context.Context, req *desc.GetRequest) (*desc.GetResponse, error) {
	...
	return &desc.GetResponse{
		Note: &desc.Note{
			Id:        id,
			Info:      &desc.NoteInfo{Title: title, Contex: body},
